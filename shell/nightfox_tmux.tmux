...
set -g status-left "#[fg=#81a1c1,bg=#232831,nobold,nounderscore,noitalics]"
...
setw -t :1 window-status-format "#[default] #I  #W #F #[fg=#232831,bg=#232831,nobold,nounderscore,noitalics]"
setw -t :1 window-status-current-format "#[fg=#81a1c1,bg=#4b5668,bold] #I  #W #F #[fg=#4b5668,bg=#232831,nobold,nounderscore,noitalics]"
